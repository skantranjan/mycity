...
/**
 * Google OAuth initiation — builds the authorization URL and redirects the
...
try {
    $url = mci_oauth_google_auth_url($redirectUri);
} catch (RuntimeException $e) {
    // Google not configured — fall back to login with an error flag

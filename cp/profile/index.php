...
if (!$bundle['ok']) {
    ...
    mci_app_profile_apply_bundle_to_session('cp', $bundle);
}
    ...
    if (!mci_csrf_verify($csrfAction, $csrfPost)) {
        ...
        if ($action === 'unlink_provider') {
            ...
            if (!$res['ok']) {
                ...
                $av = mci_app_profile_save_from_request('cp');
                if (!$av['ok']) {
...
$roleShort = (string) ($u['role'] ?? '');
$roleLabel = match ($roleShort) {
    'super_admin' => 'Super admin',
    'co_admin' => 'Co-admin',
    default => $roleShort !== '' ? $roleShort : 'Staff',
};

$avatarPreview = mci_app_profile_avatar_for_header('cp');
    ...
    <div class="card border-0 shadow-sm bg-white">
      <div class="card-body p-4">
        ...
        <div class="text-muted small mb-3">
          Control panel account details, extended profile, and linked sign-in methods.
        </div>
        ...
        <form action="" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
          ...
          <div class="row g-3 mb-4">
            ...
            <div class="col-12">
              ...
              <div class="form-text">HTTPS URL shown in the header if you have not uploaded a photo below.</div>
            </div>
        ...
        <p class="text-muted small">Social accounts for staff sign-in (when OAuth is enabled).</p>
        <?php if ($providers === []): ?>
        ...
        <div class="card bg-light border-0 mt-3">
          <div class="card-body">
            ...
            <p class="small text-muted mb-3">Only when <code>MCI_ALLOW_DEV_SOCIAL_LINK</code> is enabled.</p>

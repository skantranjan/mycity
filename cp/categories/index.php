...
(function () {
  ...
  var MCI_ICON_KEYWORDS = [
    ...
    { keywords:['water park','splash','wave pool','slides'], icon:'🌊' },
    { keywords:['adventure park','theme park','rides','roller'], icon:'🎢' },
    { keywords:['uncategorised','uncategorized','misc','general'], icon:'🏷️' },
    { keywords:['picnic','outing','day out','day trip'], icon:'🧺' },
